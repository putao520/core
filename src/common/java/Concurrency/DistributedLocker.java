...
public class DistributedLocker {
	...
	public static final DistributedLocker newLocker(String lockerName) {
		return new DistributedLocker(lockerName);
	}

	public static final DistributedLocker newLocker(String lockerName, int mode) {
	...
	public class distributedLockerMode {
