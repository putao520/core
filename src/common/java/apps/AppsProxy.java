...
public class AppsProxy {
	...
	// 获得应用信息
	public static final JSONObject getAppInfo(int appid) {
	...
	public static final JSONObject getAppInfo(String domain) {
	...
	// 获得微服务信息
	public static final JSONObject getServiceInfo(String serviceName) {
